...
export type CaseStudyMilestoneIcon =
  | "kickoff"
  | "build"
  | "beta"
  | "launch"
...
export const portfolioProjects: ProjectData[] = [
  // ── Desarrollo Web ──
  {
    ...
    title: "OTC 360",
    shortDescription:
      "Sistema de gestión de órdenes de trabajo y seguridad laboral",
    fullDescription:
  ...
  },
  {
    ...
    title: "Sistema GIS",
    shortDescription:
      "Sistema de información geográfica con capas interactivas",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Maqueta de sistema de seguimiento de auditorías para CorreosChile",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Prototipo de sitio web para proyecto inmobiliario andino",
    fullDescription:
