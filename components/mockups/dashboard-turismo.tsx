...
const SALES_HILLS = [
  20, 18, 27, 23, 39, 33, 47, 41, 37, 60, 84, 92, 14,
] as const;
...
const SPIKY = [
  18, 34, 14, 48, 24, 90, 28, 16, 62, 22, 40, 18, 56, 26, 82, 24, 34, 16, 50,
  28, 74, 20, 94, 12,
] as const;
  ...
  return (
    <WFGlyphCard className={className}>
      ...
      <div className="relative mt-2 flex-1">
        ...
        <AreaChart
          points={SPIKY}
          className="absolute inset-x-0 top-5 bottom-0 w-full"
        />
      </div>
