		...
		<section className="bg-background p-3 sm:p-4 lg:p-6">
			<div className="rounded-3xl bg-neutral-950! px-5 py-8 text-neutral-100! sm:px-8 sm:py-10 lg:px-10 lg:py-12 dark:bg-neutral-50! dark:text-neutral-900!">
				<div className="grid grid-cols-1 gap-12 lg:grid-cols-[auto_1fr_auto] lg:gap-16">
					...
					<nav aria-label="Footer" className="grid grid-cols-2 gap-x-8 gap-y-10 lg:gap-x-12">
					...
					<div className="lg:pt-px">
						<FooterAnchor
							href="/#contacto"
							className="focus-ring inline-flex items-center gap-2 rounded-full border border-neutral-700 px-5 py-3 text-xs font-semibold tracking-[0.12em] text-neutral-100 uppercase transition-colors hover:border-neutral-500 dark:border-neutral-300 dark:text-neutral-900 dark:hover:border-neutral-500"
						>
							Escríbeme
							<span aria-hidden="true">→</span>
						</FooterAnchor>
